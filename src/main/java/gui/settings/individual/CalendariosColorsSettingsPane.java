...
public class CalendariosColorsSettingsPane extends IndividualSettingsPane {
    private MigLayout layout;
    private ColorPicker domingoPicker;
    private ColorPicker sabadoPicker;

    public CalendariosColorsSettingsPane(){
        super();
        layout=new MigLayout();
        panel.setLayout(layout);
        setTitle("Colores de calendario");
    ...
    private void fillColors(){
        ...
        panel.add(sabadoPicker,"WRAP");
        panel.add(domingoPicker,"WRAP");
        revalidate();
    }
